"""
COnformer code from Hugginface with amendment for intermediate layer ouputs 
"""
    ...
    *Conformer: Convolution-augmented Transformer for Speech Recognition*
    ...
    def forward(
        ...
        Args:
            ...
            return_hidden_outputs (bool, optional): return hidden outputs or not. (Default: ``False``)
        ...
        Returns:
            (torch.Tensor, torch.Tensor)
                ...
                torch.Tensor
                    intermediate layer outputs (L, B, T, D) if ``return_hidden_outputs`` is ``True``.
        """
        ...
        for layer_idx, layer in enumerate(self.conformer_layers):
            ...
            # Append intermediate layer outputs
