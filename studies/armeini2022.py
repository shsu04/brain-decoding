...
class Armeini2022(Study):
    ...
    def __init__(
        ...
        self.cache_dir = os.path.join(os.getcwd(), cache_name, "armeini2022")
        ...
        super(Armeini2022, self).__init__()
...
class Armeini2022Recording(Recording):
    def __init__(
        ...
        super(Armeini2022Recording, self).__init__(
            bids_path=bids_path,
